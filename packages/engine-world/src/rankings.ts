 ...
 * Значення **виміряне**, а не вгадане: на реальній історії бали стабілізуються
 * до п'ятого проходу, тоді як три проходи ще міняли місцями сусідів із різницею
 * у тисячні бала. Перевіряється тестом збіжності.
 */
